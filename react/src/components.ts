...
import { ErxRating as ErxRatingElement, defineCustomElement as defineErxRating } from "@erplora/erx/dist/components/erx-rating.js";
...
type ErxRatingEvents = {
    onErxChange: EventName<ErxRatingCustomEvent<RatingChangeEvent>>,
    onErxHover: EventName<CustomEvent<number>>
};

export const ErxRating: StencilReactComponent<ErxRatingElement, ErxRatingEvents> = /*@__PURE__*/ createComponent<ErxRatingElement, ErxRatingEvents>({
    tagName: 'erx-rating',
    elementClass: ErxRatingElement,
    // @ts-ignore - React type of Stencil Output Target may differ from the React version used in the Nuxt.js project, this can be ignored.
    react: React,
    events: {
        onErxChange: 'erxChange',
    ...
    defineCustomElement: defineErxRating
});
